...
<div class="admin-content">
  ...
  <div class="dashboard-stats">
    ...
    <div class="stat-box">
      ...
      <p><span class="active">Active: <?php echo $activeTours; ?></span> | <span class="inactive">Inactive: <?php echo $inactiveTours; ?></span></p>
    </div>

    <div class="stat-box">
      <p class="stat-title">Total Flights Post</p>
      <h3><?php echo $flightCount['total']; ?></h3>
      <p><span class="active">Active: <?php echo $activeFlights; ?></span> | <span class="inactive">Inactive: <?php echo $inactiveFlights; ?></span></p>
    </div>
